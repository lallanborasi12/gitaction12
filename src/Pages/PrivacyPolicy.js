...
const PrivacyPolicy = () => {
  ...
  const htmlString = question
    ?.filter((item) => item?.policyType === "privacy")
  ...
  return (
    <>
      ...
      <div className=' md:max-w-7xl max-w-8xl mx-auto  py-7 flex flex-col   p-6 min-h-[calc(100vh-175px)] '>
               <h1 className="text-[44px] mb-2!font-serif font-bold text-customcolor">Privacy Policy</h1>  
        <div className="grid grid-cols-12 gap-5 ">
          ...
          {/* Sidebar */}
          <div className="col-span-12 md:col-span-3 bg-[#F7F7F7]  text-customcolor text-lg font-[400]  shadow-sm  md:sticky top-28 mt-5  min-h-fit md:h-[475px] rounded-3xl">
